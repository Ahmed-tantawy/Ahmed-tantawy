...
💫 About Me:
Hi there 👋 I'm Ahmed Abdelfattah Ali<br><br>Junior Software Engineer with a strong foundation in AWS, Python, and Linux, dedicated to automation, optimization, and maintaining robust cloud infrastructure.<br><br> 🚀 About Me<br>- 🔭 I'm currently working at Valeo & Commerzbank <br>- 🌱 I'm have a Bachelor's in Information Technology at the Czech University of Life Sciences Prague (CZU)<br><br>- 💬 Ask me about DevOps, SQL, AWS, Python, Linux, and automation<br><br><br> 🔥 DevOps Experience<br>- Configuration management and automation with **Red Hat Ansible**<br>- Setting up and maintaining **CI/CD pipelines** with TeamCity and Jenkins<br>- Managing containerized applications using **Podman** and **Docker**<br>- Utilizing **Elasticsearch**, **Kibana**, and **Elastalert** for monitoring<br>- Version control with **Git** (GitHub, Bitbucket)<br>- Strong Foundation in working with Databases(PostgreSQL) and SQL <br><br><br>
